...
int main() {
    ...
    std::shared_ptr<ImageWriter> image_writer = WriterFactory::create(FileType::CCI, image_reader, ScrubType::FULL, false, false);

    image_writer->convert("C:/Users/jackx/Documents/GitHub/extract-xiso/test_files/Harry Potter and the Prisoner of Azkaban (USA) full scrub ITERATIVE 2.cci");
