// #ifndef _ZAR_READER_H_
// #define _ZAR_READER_H_
...
// class ZARReader {
// public:
//     ZARReader(const std::vector<std::filesystem::path>& in_zar_filepath);
//     ~ZARReader() {};
...
//     std::string name() override { return in_zar_filepath_.front().stem().string(); };

// private:
//     std::vector<std::filesystem::path> in_zar_filepath_;
