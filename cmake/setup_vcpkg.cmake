...
elseif (UNIX)
    execute_process(COMMAND ${VCPKG_DIR}/vcpkg install lz4:x64-linux-static)
    execute_process(COMMAND ${VCPKG_DIR}/vcpkg install nlohmann-json:x64-linux-static)
    execute_process(COMMAND ${VCPKG_DIR}/vcpkg install cli11:x64-linux-static)
    execute_process(COMMAND ${VCPKG_DIR}/vcpkg install zstd:x64-linux-static)
    execute_process(COMMAND ${VCPKG_DIR}/vcpkg install openssl:x64-linux-static)
    execute_process(COMMAND ${VCPKG_DIR}/vcpkg install curl:x64-linux-static)
    execute_process(COMMAND ${VCPKG_DIR}/vcpkg install wxwidgets:x64-linux-static)
endif()